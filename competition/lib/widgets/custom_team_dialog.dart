...
class CustomTeamDialog extends StatelessWidget {
  final Team team;
  
  const CustomTeamDialog({Key? key, required this.team}) : super(key: key);
              ...
              Wrap(
                ...
                children: [
                  if (team.founded != null)
                    _buildInfoCard(context, 'Année de fondation', '${team.founded}', Icons.calendar_today),
                  if (team.clubColors != null && team.clubColors!.isNotEmpty)
                    _buildInfoCard(context, 'Couleurs', team.clubColors!, Icons.color_lens),
                  if (team.address != null && team.address!.isNotEmpty)
                    _buildInfoCard(context, 'Adresse', team.address!, Icons.location_on),
                ],
              ),
